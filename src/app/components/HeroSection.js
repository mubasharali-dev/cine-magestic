...
const HeroSection = ({title, imageUrl, width, height}) => {
    return (
        <>
                ...
                <div className={styles.container}>
                    <div className={styles.grid_two_section}>
                        ...
                        <div className={heroStyles.hero_image}>
                            <Image src={imageUrl} alt={"hero section"} width={width} height={height}/>
                        </div>
                    </div>
                </div>
                <div className={heroStyles["custom-shape-divider-bottom-1694253161"]}>
